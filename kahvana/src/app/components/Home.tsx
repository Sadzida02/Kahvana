  ...
  return (
    <div>
        <div id='banner' className='text-white flex flex-col items-center justify-center text-center gap-5 bg-cover bg-no-repeat bg-center h-1040 custom-img' >
            <div className='w-526 mt-36 font-extrabold'>
            ...
            <a href="/mobileDeveloperApplication" className='bg-kahvanaPink text-white text-sm font-semibold w-167 h-49 text-center p-4 rounded-2xl'>Get in Touch <FontAwesomeIcon icon={faPaperPlane} className='ml-2 inline' width={16} height={16} /></a>
        </div>      
    </div>
  )
}
