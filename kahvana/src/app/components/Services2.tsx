  ...
  return (
    <div className='text-white my-24'>
        <div className='flex items-center justify-center'>
            <div className='w-[500px] h-0.5 bg-white'></div>
         ...
         <div className='h-366 flex justify-around items-center mt-8 mx-190'>
            <div className='hover:bg-white hover:text-black p-5 rounded-2xl'>
                ...
                <a href="/marketing" className='text-sm font-light'>More about this service <FontAwesomeIcon icon={faArrowRight} className='ml-2 inline' width={16} height={16}></FontAwesomeIcon></a>
            </div>
